...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="mExpressController.do?doAdd" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
						<t:dictSelect field="expressType" typeGroupCode="expreType" hasLabel="false"></t:dictSelect>
						<span class="Validform_checktip"></span>
