...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="caijiStoreController.do?doUpdate" tiptype="1">
					...
					<tr>
						...
						<td class="value">
						     	 <input id="storeName" name="storeName" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${caijiStorePage.storeName}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="storeFaceback" name="storeFaceback" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${caijiStorePage.storeFaceback}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="storeFacebackper" name="storeFacebackper" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${caijiStorePage.storeFacebackper}'>
							<span class="Validform_checktip"></span>
