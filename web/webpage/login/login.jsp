...
<body>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <%--<div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="#" title=<t:mutiLang langKey="common.platform"/>>jeecg</a> <t:mutiLang langKey="common.browser.recommend"/>:</span></div>--%>
    </div>
    <!-- Link JScript-->
