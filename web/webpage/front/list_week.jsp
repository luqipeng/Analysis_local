...
<div class="container">
    ...
    <a class="brand" href="">周销量排行榜</a>
    
    <div class="nav-collapse">     
 <p class="tagline" style="float:right;"> <a class="brand" href="loginController.do?login">首页</a><a class="brand" href="frontController.do?ru">团购</a><a class="brand" href="frontController.do?day">今日销量排行榜</a><span class="brand">业务员:${userName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span> <a class="brand" href="loginController.do?admin">系统设置</a>  
...
<form id="search_in_category_and_all_form" action="#">
	...
	周销量区间:<input id="productOrdersBegin" name="productOrdersBegin" type="text" style="width: 100px" class="inputxt">~<input id="productOrdersEnd" name="productOrdersEnd" type="text" style="width: 100px" class="inputxt">	
...
<script>
	...
	function fillData(data) {
		...
		for (var i = 0, l, tr, title; i < data.rows.length; i++) {
				l = data.rows[i];
				str += "<li class=\"sale_amount \" id=\""+l.productId+"\"><a href=\"http://www.aliexpress.com/item/"+l.productUrl.replace("//www.aliexpress.com/item/","")+"\" class=\"thumbnail\" target=\"view_window\"><span class=\"badge badge-info sort_order\"></span><img width=\"220\" src=\""+l.productImg+"\" alt=\""+l.productId+"\">";
				str += "<table><tr><td>周销量:<span class=\"price\">"+l.weekOrders+"</span></td><td>价格:<span class=\"price\">US $"+l.productPrice+"</span></td></tr>";
	...
	function searchCurrent(page) {
			...
			var urlstr = "frontController.do?list_week&field=id,productId,productUrl,productImg,productName,productOrdersAll,productOrdersToday,productPrice,storeId,productDsr,productFaceback,categoryName,categoryOrders,weekOrders,amount,weekAmount&page=" + page+"&productDsrZero="+productDsrZero;
		...
		function initDate(){
			var urlstr = "frontController.do?list_week&field=id,productId,productUrl,productImg,productName,productOrdersAll,productOrdersToday,productPrice,storeId,productDsr,productFaceback,categoryName,categoryOrders,weekOrders,amount,weekAmount&page=" + 1;
			$.ajax({
				url: urlstr,
				success: function (data) {
					$('#page').jqPaginator('option', {
